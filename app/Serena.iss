  #define MyAppName "Serena"
#define MyAppVersion "0.0.0"
#define MyAppExeName "Serena.bat"
#define RVersion "3.4.4"
...
[Setup]
AppName = {#MyAppName}
AppId = {{5PCOVMC2-EJIE-BRFU-EYZ0-D02T8O5H9RSY}
...
Source: "Serena.bat"; DestDir: "{app}"; Flags: ignoreversion;
